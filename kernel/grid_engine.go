...
- close_long: 平掉多头仓位（趋势反转或风控触发时）
- close_short: 平掉空头仓位（趋势反转或风控触发时）
...
- close_long: Close long position (when trend reverses or risk controls trigger)
- close_short: Close short position (when trend reverses or risk controls trigger)
