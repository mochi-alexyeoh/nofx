...
export const coinSource = {
  ...
  ai500: { zh: 'AI 数据源', en: 'AI Data Provider', es: 'Proveedor AI' },
  ...
  useAI500: { zh: '启用 AI 数据源', en: 'Enable AI Data Provider', es: 'Habilitar AI' },
  ...
  ai500Desc: { zh: '使用 AI 智能筛选的热门币种', en: 'Use AI smart-filtered popular coins', es: 'Monedas filtradas por AI' },
...
export const indicator = {
  ...
  newsFundamental: { zh: '新闻面', en: 'News Fundamentals', es: 'Fundamentales News' },
  ...
  useAlphaVantage: { zh: '启用 Alpha Vantage', en: 'Enable Alpha Vantage', es: 'Activar Alpha Vantage' },
  alphaVantageApiKey: { zh: 'Alpha Vantage API Key', en: 'Alpha Vantage API Key', es: 'API Key Alpha Vantage' },
  useAlphaVantageSentiment: { zh: '使用 Alpha Vantage 新闻情绪', en: 'Use Alpha Vantage News Sentiment', es: 'Usar Sentimiento de Alpha Vantage' },
  tickerScope: { zh: 'Ticker 范围', en: 'Tickers Scope', es: 'Alcance de Tickers' },
  tickerScopeAuto: { zh: '自动（来自币池）', en: 'AUTO (from coin source)', es: 'AUTO (desde fuente de monedas)' },
  tickerScopeManual: { zh: '手动', en: 'Manual', es: 'Manual' },
  manualTickers: { zh: '手动 Tickers（逗号分隔）', en: 'Manual Tickers (comma-separated)', es: 'Tickers manuales (separados por coma)' },
