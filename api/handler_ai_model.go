...
func (s *Server) handleGetSupportedModels(c *gin.Context) {
	...
	supportedModels := []map[string]interface{}{
		...
		{"id": "openrouter", "name": "OpenRouter", "provider": "openrouter", "defaultModel": "openrouter/auto"},
		...
		{"id": "claw402", "name": "x402 Protocol (Base USDC)", "provider": "claw402", "defaultModel": "deepseek-v4-flash"},
	}
